...
<head>
	...
	<link rel="stylesheet" href="/static/demos/travel/travel.css" type="text/css" />
	<link rel="stylesheet" href="/static/demos/travel/css/datepicker.css" type="text/css" />
	<!-- / -->
	...
	<![endif]-->
	<!-- <link rel="stylesheet" href="/static/css/colors.php%3Fcolor%3DAC4147" type="text/css" /> -->


	<!-- Document Title
	============================================= -->
	<title>TruckBooking | Homepage</title>
...
<body class="stretched" onload="initialize()">
				...
				<div class="col_half fright col_last clearfix nobottommargin"> -->
					...
					<!-- <div id="top-social">
						<ul>
							...
							<li><a href="tel:+91.11.85412542" class="si-call"><span class="ts-icon"><i class="icon-call"></i></span><span class="ts-text">+91.8281900163</span></a></li>
			...
			<header id="header" class="transparent-header dark" data-sticky-class="not-dark" data-responsive-class="not-dark">
				...
				<div id="header-wrap">
					...
					<div class="container clearfix">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="/static/images/logo-dark.png"><img src="/static/images/logo.png" alt="Canvas Logo"></a>
						...
						<nav id="primary-menu" class="style-4">
							...
							<ul>
								...
								<li><a href="#"><div><i class="icon-plane"></i>About Us</div></a></li>
								<li><a href="#"><div><i class="icon-building"></i>Contact Us</div></a></li>
								<li><a href="#"><div><i class="icon-gift"></i>How it works</div></a></li>
				...
				<div class="fslider" data-speed="3000" data-pause="7500" data-animation="fade" data-arrows="false" data-pagi="false" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; background-color: #333;">
					<div class="flexslider" style="height: 100% !important;">
						<div class="slider-wrap" style="height: inherit;">
							<div class="slide" style="background: url(/static/demos/travel/images/slider/1.jpg) center center; background-size: cover; height: 100% !important;"></div>
							<div class="slide" style="background: url(/static/demos/travel/images/slider/2.jpg) center center; background-size: cover; height: 100% !important;"></div>
							<div class="slide" style="background: url(/static/demos/travel/images/slider/3.jpg) center center; background-size: cover; height: 100% !important;"></div>
						</div>
					</div>
				</div>
						...
						<div class="container clearfix">
							...
							<div class="tabs travel-organiser-tabs clearfix">
								...
								<ul class="tab-nav clearfix">
									<li><a href="#tab-trucks"><i class="icon-truck"></i><span class="hidden-xs">Trucks</span></a></li>
									<li><a href="#tab-partload"><i class="icon-building"></i><span class="hidden-xs">Part Load</span></a></li>

								</ul>

								<div class="tab-container">

									<div class="tab-content clearfix" id="tab-trucks">
										<div class="heading-block nobottomborder bottommargin-sm clearfix">

											<h4 class="fleft">Book your Truck</h4>
											<div class="row">
  <div class="col-sm-8 col-sm-offset-2">
    <p>
										...
										<input type="hidden" name="_csrf_token" value="545c360ad66925d62ae63c54611a40da8444a2ab">
											<div class="row">
												<div class="col-sm-6 col-xs-12 bottommargin-sm">
													<label for="">From</label>
													<input type="text" value="" class="sm-form-control" placeholder="Eg. Kochi" id="source" name="source" required>
												</div>
												<div class="col-sm-6 col-xs-12 bottommargin-sm">
													<label for="">To</label>
													<input type="text" value="" class="sm-form-control" placeholder="Eg. hi" id="destination" name="destination" required>
												</div>
												<div class="clear"></div>
												<div class="input-daterange travel-date-group col-sm-6 bottommargin-sm">
													<div class="row">
														<div class="col-sm-12 col-xs-12">
															...
															<input type="text" value="" class="sm-form-control tleft" name="date" id="date" placeholder="MM/DD/YYYY" required>
														</div>
													</div>
												</div>
												<div class="col-sm-6 col-xs-12 bottommargin-sm">
													<label for="">Material</label>
													<input type="text" value="" class="sm-form-control" placeholder="Eg. Plywood" id="material" name="material" required>
												</div>
												<div class="col-sm-6 col-xs-12 bottommargin-sm">
													<label>Weight</label>
													<div>
													<select class="selectpicker" title="Select weight range" name="weight" id="weight" required>
														<option> < 9 tonnes</option>
												...
												<div class="col-sm-12">
													<button class="button button-3d nomargin rightmargin-sm" style="float:right">Submit Enquiry</button>
												</div>
											</div>
										</form>
									</div>
									<div class="tab-content clearfix" id="tab-partload">
										<div class="heading-block nobottomborder bottommargin-sm clearfix">
											<h4 class="fleft">Coming Soon</h4>
										</div>
									</div>
		...
		<section id="content">
			...
			<div class="content-wrap">
					...
					<div class="row topmargin-sm bottommargin-sm">
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							...
							<div class="heading-block nobottomborder nobottommargin">
								<span class="before-heading">Easy &amp; Fast.</span>
								<h4>Request Trucks</h4>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							...
							<div class="heading-block nobottomborder nobottommargin">
								<span class="before-heading">Over 1000 agents.</span>
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							...
							<div class="heading-block nobottomborder nobottommargin">
								<span class="before-heading">Safe & Secure.</span>
								<h4>Realtime tracking of trucks.</h4>
							</div>
						</div>
						...
						<div class="max-height clearfix">
							...
							<div class="spost col-md-12 col-sm-6 noborder noleftpadding clearfix">
								<!-- <div class="entry-image">
									<a href="#"><img src="images/magazine/small/1.jpg" alt=""></a>
								</div> -->
								<div class="entry-c">
									<div class="entry-title">
										<h4><a href="#">Mangaluru</a></h4>
									</div>
									<!-- <ul class="entry-meta">
							...
							<div class="spost col-md-12 col-sm-6 noborder noleftpadding clearfix">
								<!-- <div class="entry-image">
									<a href="#"><img src="images/magazine/small/2.jpg" alt=""></a>
								</div> -->
								<div class="entry-c">
									<div class="entry-title">
							...
							<div class="spost col-md-12 col-sm-6 noborder noleftpadding clearfix">
								<!-- <div class="entry-image">
									<a href="#"><img src="images/magazine/small/3.jpg" alt=""></a>
								</div> -->
								<div class="entry-c">
									<div class="entry-title">
				...
				<a href="#" class="button button-full button-dark center bottommargin-lg">
					<div class="container clearfix">
						Can't find a truck? <strong>Contact Us Directly</strong> <i class="icon-caret-right" style="top:4px;"></i>
					</div>
				</a>
	...
	<script type="text/javascript" src="/static/demos/travel/js/datepicker.js"></script>
	<!-- / -->
	...
	<script type="text/javascript" src="/static/js/components/selectsplitter.js"></script>
	<!-- / -->

	<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyDjLjFPVX_H9OTvZdk-ssuti44s3A_Uj8E"></script>
	<script type="text/javascript" src="/static/js/jquery.gmap.js"></script>

	<!-- Autocomplete -->
	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDklEXhtOUvNxyrMkPnMogxqz-CAp940AM&libraries=places"></script>
				...
				markers: [
					{
						...
						icon: {
							image: "/static/images/icons/map-icon-red.png",
							iconsize: [32, 39],
							iconanchor: [16,36]
						}
					},
